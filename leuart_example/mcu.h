...
typedef struct
{
    ...
    _I  uint32_t STATUS;
    _IO uint32_t CLKDIV;
    _IO uint32_t STARTFRAME;
    _IO uint32_t SIGFRAME;
    _I  uint32_t RXDATAX;
    _I  uint32_t RXDATA;
    _I  uint32_t RXDATAXP;
    _O  uint32_t TXDATAX;
    _O  uint32_t TXDATA;
    _I  uint32_t IF;
    _O  uint32_t IFS;
    _O  uint32_t IFC;
    _IO uint32_t IEN;
    _IO uint32_t PULSECTRL;
    _IO uint32_t FREEZE;
    _I  uint32_t SYNCBUSY;
...
#define LEUART0             ((LEUART_TypeDef *)     LEUART0_BASE  )   /*!< LEUART0 configuration struct       */
#define WDOG                ((WDOG_TypeDef   *)     WDOG_BASE     )   /*!< Watchdog configuration struct      */
#define MSC                 ((MSC_TypeDef    *)     MSC_BASE      )   /*!< Memory Storage Controller configuration struct */
